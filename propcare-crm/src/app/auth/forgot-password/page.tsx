...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative" style={{ backgroundColor: "var(--black-950)" }}>
      {/* Theme Toggle */}
      <button
        onClick={toggleTheme}
        className="absolute top-4 right-4 w-9 h-9 flex items-center justify-center rounded-[8px] transition-all"
      ...
      <div className="w-full max-w-sm animate-slide-up">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold" style={{ fontFamily: "'Playfair Display', serif", color: "var(--gold-400)" }}>Nations of Sky</h1>
        ...
        {sent ? (
          <div className="text-center space-y-4">
            ...
            <div>
              <h2 className="text-xl font-bold mb-2" style={{ fontFamily: "'Playfair Display', serif", color: "var(--text-primary)" }}>Check your email</h2>
              <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                We sent a reset link to <span style={{ color: "var(--gold-400)" }}>{email}</span>
              </p>
              <p className="text-xs mt-2" style={{ color: "var(--text-muted)" }}>Click the link in the email to set a new password.</p>
            </div>
          ...
          <>
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-1" style={{ fontFamily: "'Playfair Display', serif", color: "var(--text-primary)" }}>Forgot password?</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@nationsofsky.com" startIcon={<Mail className="w-3.5 h-3.5" />} required autoComplete="email" />
              </div>
