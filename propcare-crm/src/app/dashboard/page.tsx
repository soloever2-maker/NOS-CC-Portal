...
import {
  ...
  Plus, ArrowRight, ShieldCheck, ShieldAlert, ShieldX, Calendar,
} from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen animate-fade-in">
      ...
      <div className="flex-1 p-5 space-y-5">
        ...
        {/* ── Bottom: Recent Tickets + Category ─────────── */}
