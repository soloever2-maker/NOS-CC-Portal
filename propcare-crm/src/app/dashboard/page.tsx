...
export default function DashboardPage() {
  ...
  const statusCards = [
    ...
    { label: "Resolved ✅",    value: stats?.resolvedCount ?? 0,      icon: CheckCircle, color: "#16a34a", bg: "rgba(22,163,74,0.06)",    border: "rgba(22,163,74,0.18)",    href: "/dashboard/tickets?status=RESOLVED",       hint: "resolved within SLA time"   },
