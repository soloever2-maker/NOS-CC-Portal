...
export default function NewTicketPage() {
  ...
  const [form, setForm] = useState({
    ...
    clientId: "", propertyId: "", assignedToId: "", dueDate: "", tags: "",
  });
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div><Label className="mb-1.5 block">Source</Label>
                    ...
                    <div><Label className="mb-1.5 block">Due Date</Label>
                  ...
                  {isAdmin && (
                    <div>
                      <Label className="mb-1.5 block">
                        Assign To
                        <span className="ml-2 text-[10px] px-1.5 py-0.5 rounded-full" style={{ background: "var(--gold-glow)", color: "var(--gold-500)" }}>Admin</span>
                      </Label>
