      ...
      <div className="flex-1 p-5 space-y-4">
        ...
        <div className="rounded-[12px] overflow-hidden" style={{ border: "0.5px solid var(--border)", background: "var(--black-800)" }}>
          <table className={`crm-table${compact ? " compact" : ""}`}>
            <thead>
              <tr>
                <th>Code</th><th>Ticket</th><th>Project</th><th>Client</th><th>Unit</th>
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={12} className="text-center py-10"><div className="w-5 h-5 border-2 border-t-[var(--gold-500)] rounded-full animate-spin mx-auto" /></td></tr>
              ) : tickets.length === 0 ? (
                <tr><td colSpan={12} className="text-center py-10" style={{ color: "var(--text-muted)" }}>
