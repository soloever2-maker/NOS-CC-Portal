...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between rounded-[8px] px-3 py-2 text-sm",
      "bg-[var(--black-700)] border border-[var(--black-500)] text-[var(--text-primary)]",
      "placeholder:text-[var(--text-muted)]",
      "focus:outline-none focus:border-[var(--gold-500)] focus:ring-1 focus:ring-[var(--gold-glow)]",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-[var(--gold-glow)] focus:text-[var(--gold-400)]",
